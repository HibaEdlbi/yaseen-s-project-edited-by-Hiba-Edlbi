...
public class EduPrincetonCsAlgs4 {
    ...
    public static void main(String[] args) {
        ...
        switch (HelpShowing.chooseTipe()){
            ...
            case "c":
                SinCos y=null;
                System.out.println("please enter the number you want calculate sin,cos,tan:");
                double d;
            ...
            case "d":
                Exponential w=null;
                System.out.println("please enter the number you want calculate exp:");
                double f;
                f=scanner.nextDouble();
                System.out.println("exp:"+Math.exp(f));
                break;
        }
